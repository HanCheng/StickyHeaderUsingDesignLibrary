package com.hancheng.optimizedapp.behaviors;
...
public class ToolBarBehavior extends CoordinatorLayout.Behavior<TitleView> {
    ...
    private void shouldInitProperties(TitleView child, View dependency) {
